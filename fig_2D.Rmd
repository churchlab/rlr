...
color_list = c('#F8766D','#00B4F0','#FF64B0',
               '#DE8C00','#00BA38','#619CFF',
               '#B79F00','#00C08B','#C77CFF',
               '#7CAE00','#00BFC4','#F564E3')
...
```
```{r save_figure}
ggsave(here::here('fig_2D_quasi.pdf'), plot=fig_1D, width=figure_width*(3/5), 
       height=figure_height*(1/3), units='in', dpi=300, device = cairo_pdf)
#ggplotly()
```
