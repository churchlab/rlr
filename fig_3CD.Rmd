...
ggsave(filename='fig_3C.pdf', plot=fig3c, width=6, height=3, units='in', dpi=300, device=cairo_pdf)
...
```{r save_fig3D}
ggsave(here::here('fig_3D.pdf'), plot=fig3d, width=5, height=3, units='in', dpi=300, device = cairo_pdf)
