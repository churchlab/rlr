...
parent_folder <- here::here('supplemental_figures/figS3C')
```
...
fig_s3C <- ggplot(h10, aes(x= locus, y=fraction_edited, color=locus)) + 
...
ggsave(here::here('supplemental_figures/fig_s3C.pdf'), plot=fig_s3C, width=4, 
