...
fig3b <- ggplot(summary,
  ...
  labs(y='Allelic enrichment in population', x='') +
...
ggsave(here::here('fig_3b.pdf'), plot=fig3b, width=5, height=4, units='in', dpi=300)
...
ggsave(here::here('fig_3b_summary.pdf'), plot=fig3b_summ, width=4, height=4, units='in', dpi=300, useDingbats=FALSE)
#save('megatable5', file=here::here('fig_3b','fig3bdata.RData'))
```
