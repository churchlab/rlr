...
s1_9_path = paste(parent_folder, s1_9_table, sep = "/")
...
s1_9_dt = data.table(fread(s1_9_path))

#filter s1_9

#S2 is the relevant "before" sample for fig 4 deseq
s2_dt <- s1_9_dt[EXPERIMENT_SAMPLE_LABEL == "s2"]

```


```{r combinedata}
combined_dt = rbind(before38_dt[, ], before40_dt, test_file_dt, s1_9_dt)
