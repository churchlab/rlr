...
ggplot(current, aes(x=nickname, y=median_enrichment, color=mut_class, fill = mut_class)) + 
...
ggplot(binary_summ[mut_class=='Drug_resistance'], aes(x=rif, y=median_enrichment, group=nickname)) + 
  geom_linerange(aes(ymin=min_enrichment, ymax=max_enrichment), color="black", alpha = 0.3) +  
