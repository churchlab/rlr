...
fig2b <- ggplot(current, aes(x=nickname, y=median_enrichment, color=as.factor(color_cat), fill = as.factor(color_cat))) + 
...
fig2c <- ggplot(binary_summ[mut_class=='rpoB Alleles'], 
    aes(x=rif, y=median_enrichment, group=nickname, color=as.factor(color_cat))) + 
